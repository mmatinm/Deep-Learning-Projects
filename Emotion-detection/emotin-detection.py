...
In this question, I used the CK+ dataset to train a CNN model for classification. Below are the details of my approach and findings:

1. Batch Size:  
   I manually optimized the batch size by testing values of 32, 64, and 128. Due to the limited amount of data, a batch size of 64 gave the best results.

2. Image Size: 
   I chose an image size of 48x48 pixels because it preserves enough details to differentiate between classes. Larger sizes would increase computational cost, while smaller sizes would make learning harder.

3. Data Augmentation:  
   Since the dataset is severely imbalanced, I applied data augmentation to help improve generalization and balance.

4. Model Architecture: 
   With a total of 1140 training images, I avoided complex models. I tested a variety of simple CNN architectures over almost a day, including models inspired by ResNet and Inception modules, ensuring the number of parameters stayed under 500k to avoid overfitting.

5. Loss Function:  
   Due to the severe class imbalance, I used a weighted categorical cross-entropy loss function and manually optimized the class weights.

6. Learning Rate: 
   Through trial and error, I found that a learning rate of 0.00008 and training for more than 100 epochs was a good approach to train the model effectively.

---

## Final Model Characteristics

- **Model saved as:** `Q3.keras`  
- **Input size:** 48x48  
- **Weighted test accuracy:** 0.88  
- **Confusion matrix:** Provided at the end of Q3 Part 1  

---

## Part 2: Filter Visualization

In Part 2, I plotted some of the CNN filters’ outputs. The results were quite interesting: the model learned to focus on lips and eyebrows for classification and even recognized human faces.

---

## Part 3: Webcam Testing

In Part 3, I used my webcam to capture 10 photos and a short video (provided along with this code). Due to the dataset's severe imbalance, I made a sad face (one of the classes with low data samples). When passing these images to the model, it predicted "angry." After analyzing the dataset, I realized sadness and anger expressions are quite similar in this dataset, highlighting the importance of having a rich and diverse dataset. For example, people express sadness very differently, which makes classification challenging.
